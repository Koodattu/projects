...
*These are my main focus areas. I'm actively pushing code to these daily.*
...
<table width="100%">
  ...
  <tr>
    <td colspan="2" style="border: none;">
      <p>AI Workshop Playground is an educational IDE designed for workshops. It allows participants to describe web components in natural language (English or Finnish) and watch as Google Gemini 2.5 Flash streams production-ready HTML, CSS, and JS into a Monaco editor with an instant live preview. It includes a full admin dashboard for managing workshop passwords and usage limits.</p>
    </td>
  </tr>
</table>
...
<table width="100%">
  <tr>
    <td align="center" colspan="2" style="border: none;">
      <img src="https://i.imgur.com/5jYLyf5.png" alt="Fyr'alath Data Tracker Preview" width="100%" style="border-radius: 12px;">
    </td>
  </tr>
  <tr>
    <td align="left" style="border: none;">
  ...
  <tr>
    <td colspan="2" style="border: none;">
      <p>This project tracks the "price-to-craft" for the Fyr'alath legendary axe across all World of Warcraft regions. It features a Python Flask backend that aggregates data from the Blizzard Game Data API and Raider.io to visualize regional price histories and daily acquisition trends per character class using interactive Chart.js visualizations.</p>
    </td>
  </tr>
</table>
